// Email sent to user when they submit an appointment request

interface AppointmentAcknowledgementProps {
  name: string
  sessionType: string
  therapist: string
  date: string
...
export function generateAppointmentAcknowledgement(props: AppointmentAcknowledgementProps) {
  return `
<!DOCTYPE html>
<html>
<head>
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a5568; text-align: center;">
                We've received your appointment request and it's currently <strong>pending confirmation</strong>. 
              ...
              <div style="background-color: #f7fafc; border-radius: 8px; padding: 24px; margin: 32px 0;">
                ...
                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                  ...
                  <tr>
                    <td style="padding: 8px 0; font-size: 14px; color: #718096;">Therapist:</td>
                    <td style="padding: 8px 0; font-size: 14px; color: #2d3748; font-weight: 500;">${props.therapist}</td>
                  </tr>
                  <tr>
              ...
              <p style="margin: 24px 0 0; font-size: 14px; line-height: 1.6; color: #718096; text-align: center;">
                If you have any questions in the meantime, feel free to reply to this email or call us at (555) 123-4567.
              </p>
            </td>
          </tr>
